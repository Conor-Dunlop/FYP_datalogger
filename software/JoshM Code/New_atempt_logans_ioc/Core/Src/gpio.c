...
// SX1262 RESET I/O definitions

#define SX126X_RESET_GPIO_Port GPIOC // STM32 pin
#define SX126X_RESET_Pin GPIO_PIN_10 // STM32 pin

// SX1262 DIO pin definitions

#define SX126X_DIO2_GPIO_Port GPIOC // STM32 pin
#define SX126X_DIO2_Pin GPIO_PIN_8 // STM32 pin

// SX1262 NSS pin definitions

#define SX126X_NSS_GPIO_Port GPIOC // set this
#define SX126X_NSS_Pin GPIO_PIN_7  // set this

// SX1262 Busy Pin definitions

#define SX126X_BUSY_GPIO_Port GPIOC  // set this
#define SX126X_BUSY_Pin GPIO_PIN_9 // set this
...
void MX_GPIO_Init(void)
{
  ...
  // Lora pins
  // SX1262 GPIO pin configurations
  ...
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SX126X_RESET_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(SX126X_NSS_GPIO_Port, &GPIO_InitStruct);

  /* SX1262 DIO2 */
  GPIO_InitStruct.Pin = SX126X_DIO2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;  // Assuming DIO2 is an input (double check)
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SX126X_DIO2_GPIO_Port, &GPIO_InitStruct);

  /* SX1262 BUSY */
  GPIO_InitStruct.Pin = SX126X_BUSY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;  // Typically configured as an input (double check)
  GPIO_InitStruct.Pull = GPIO_NOPULL;
