...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB14     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOC, ADC_7_Pin|ADC_8_Pin|ADC_9_Pin|ADC_10_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC_1_Pin|OPAMP_SIG_2_Pin|OPAMP_SIG_4_Pin);

    HAL_GPIO_DeInit(GPIOB, OPAMP_SIG_1_Pin|ADC_3_Pin|DIGITAL_IO_2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(OPAMP_SIG_3_GPIO_Port, OPAMP_SIG_3_Pin);
