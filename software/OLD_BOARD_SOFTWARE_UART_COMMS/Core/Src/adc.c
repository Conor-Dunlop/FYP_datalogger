...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB14     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOC, SIG_4_Pin|SIG_2_Pin|ADC_9_Pin|ADC_10_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC_1_Pin|ADC_2_Pin|ADC_4_Pin);

    HAL_GPIO_DeInit(GPIOB, PWM_OUT_Pin|ADC_3_Pin|GPIO_PIN_14);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC5     ------> ADC2_IN11
    */
    HAL_GPIO_DeInit(ADC_12_GPIO_Port, ADC_12_Pin);
